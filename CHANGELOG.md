...
- Version check for deprecated ExtensionManagementUtility::addModule

## [12.1.0] - 2024-09-16

### Changed

- Updated AdminerEvo to 4.8.4

### Fixed

- Styling of buttons above list of tables
- New icon for editing all records
...
- autoload configuration in ext_emconf.php for non-composer installations
